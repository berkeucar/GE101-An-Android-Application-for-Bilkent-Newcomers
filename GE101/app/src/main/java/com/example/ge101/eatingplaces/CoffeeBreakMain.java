...
public class CoffeeBreakMain extends FragmentActivity implements OnMapReadyCallback
    ...
    private static final String TAG = "CBMapActivity";
    ...
    /**
     * The method that opens the menu for Coffee Break (Main Campus)
     */
    private void openMenu() {
        // creates intent (action) and opens it (for this condition Coffee Break's menu)
    ...
    public void onMapReady( GoogleMap googleMap) {
        ...
        PlaceInfo placeInfo = new PlaceInfo("Coffee Break ", "Coffee Break in T building", new LatLng(39.868290, 32.749084), R.drawable.t);
                        ...
                        public void onComplete(@NonNull Task task) {
                            if ( task.isSuccessful())
                            {
                                ...
                                else
                                {
                                    ...
                                    Toast.makeText( CoffeeBreakMain.this, "You are not in Bilkent.", Toast.LENGTH_SHORT).show();
                                }

                            }
                            else {
                                Log.d( TAG, "onComplete: current location is null");
                                Toast.makeText( CoffeeBreakMain.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
